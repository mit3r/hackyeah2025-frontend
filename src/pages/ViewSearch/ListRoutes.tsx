...
export default function ListRoutes() {
  ...
  return (
    <div className="my-shadow flex w-full flex-1 flex-col gap-5 overflow-y-auto rounded-2xl bg-white p-4">
      ...
      {connections.map((connection, index) => {
        ...
        return (
          <div
            key={index}
            className="cursor-pointer rounded-lg border-b border-gray-200 p-3 pb-4 transition-colors last:border-b-0 hover:bg-gray-50"
